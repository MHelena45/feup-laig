...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene.securityCamera, 'lineComponentR', 0, 1.0).name('Line component R');
        this.gui.add(this.scene.securityCamera, 'lineComponentG', 0, 1.0).name('Line component G');
        this.gui.add(this.scene.securityCamera, 'lineComponentB', 0, 1.0).name('Line component B');
